class LiassesController < ApplicationController
  ...
  def index
    if params[:building_id] != nil
      ...
      @expenses_active = Expense.where("statut = ? AND user_id = ?", "active", current_user.id)
      if params[:search] == nil || params[:search][:company] == "Toutes les sociétés" && params[:search][:building] == "Tous les immeubles" && params[:search][:apartment] == "Tous les appartements"
        @rent_paid = @rents_active
        @expenses_array = @expenses_active
        # @tenants.each do |t|
        ...
        @rent_paid = @rents_active.select { |t| t.tenant.building_name == params[:search][:building]  }
        ...
        @rent_paid = @rents_active.select { |t| t.tenant.apartment_name == params[:search][:apartment] }
        ...
        @rent_paid = @rents_active.select { |t| t.tenant.building_name == params[:search][:building] && t.tenant.apartment_name == params[:search][:apartment]  }
        ...
        @rent_paid = @rents_active.select { |t| t.tenant.company_name == params[:search][:company] && t.tenant.building_name == params[:search][:building] && t.tenant.apartment_name == params[:search][:apartment]  }
        ...
        @rent_paid = @rents_active.select { |t| t.tenant.company_name == params[:search][:company] }
        ...
        @rent_paid = @rents_active.select { |t| t.tenant.company_name == params[:search][:company] && t.tenant.building_name == params[:search][:building] }
        ...
        @rent_paid = @rents_active.select { |t| t.tenant.company_name == params[:search][:company] && t.tenant.apartment_name == params[:search][:apartment]  }
